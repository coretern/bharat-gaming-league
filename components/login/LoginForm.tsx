      ...
      <form onSubmit={handleSubmit} className="space-y-3.5 text-left">
          ...
          <div className="space-y-0.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-11 bg-slate-50/50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800 rounded-xl pl-12 pr-12 text-[11px] font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-google-blue/15 focus:border-google-blue transition-all placeholder:text-slate-500 dark:placeholder:text-slate-400 placeholder:opacity-100"
                required
              />
              <button
                type="button"
        ...
        <div className="text-right">
          <button
            ...
            className="text-[9px] font-black uppercase tracking-widest text-google-blue hover:text-blue-600 transition-colors"
          >
            Forgot Password?
          </button>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full h-11 bg-google-blue text-white rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-blue-600 transition-all shadow-md active:scale-98 flex items-center justify-center gap-2"
        >
          {loading ? 'Signing in...' : (
            <>
