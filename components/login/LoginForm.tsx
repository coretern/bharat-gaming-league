  ...
  return (
    <div className="space-y-3">
      <form onSubmit={handleSubmit} className="space-y-2.5 text-left">
        {error && (
          <div className="p-2 bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20 rounded-xl flex items-start gap-2">
        ...
        {isGoogleAccount && (
          <div className="p-2 bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 rounded-xl flex items-start gap-2">
            <AlertCircle className="w-3.5 h-3.5 text-google-blue shrink-0 mt-0.5" />
            <span className="text-[10px] font-bold text-google-blue leading-tight">
        ...
        <div className="space-y-2.5">
          ...
          <div className="space-y-0.5">
            <label className="text-[8px] font-black tracking-widest text-slate-400 dark:text-slate-500 uppercase">
              Email Address
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-10 bg-slate-50/50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800 rounded-xl pl-10 pr-3 text-[11px] font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-google-blue/15 focus:border-google-blue transition-all placeholder:text-slate-500 dark:placeholder:text-slate-400 placeholder:opacity-100"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-0.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-10 bg-slate-50/50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800 rounded-xl pl-10 pr-10 text-[11px] font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-google-blue/15 focus:border-google-blue transition-all placeholder:text-slate-500 dark:placeholder:text-slate-400 placeholder:opacity-100"
                required
              />
              <button
                type="button"
        ...
        <div className="text-right">
          <button
            ...
            className="text-[8px] xs:text-[9px] font-black uppercase tracking-widest text-google-blue hover:text-blue-600 transition-colors"
          >
            Forgot Password?
          </button>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full h-10 bg-google-blue text-white rounded-xl font-bold text-[11px] uppercase tracking-widest hover:bg-blue-600 transition-all shadow-md active:scale-98 flex items-center justify-center gap-2"
        >
          {loading ? 'Signing in...' : (
            <>
      ...
      <div className="relative flex items-center justify-center my-3">
        <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-slate-100 dark:border-slate-800/80"></div></div>
      ...
      <div className="text-center pt-1">
        <p className="text-[10px] font-bold text-slate-400">
          Don't have an account? <button onClick={() => onSwitchMode('signup')} className="text-google-blue font-black hover:underline ml-1">Register here</button>
        </p>
      </div>
    </div>
  );
