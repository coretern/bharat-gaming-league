...
export default function ForgotPasswordForm({ email, setEmail, onSwitchMode, onResetSuccess }: ForgotPasswordFormProps) {
    ...
    return (
      <div className="space-y-4">
        <div className="text-left bg-slate-50 dark:bg-slate-950 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-0.5">Reset password</p>
        ...
        <form onSubmit={handleInitSubmit} className="space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-xl pl-10 pr-3 text-[11px] font-medium focus:outline-none focus:ring-2 focus:ring-google-blue/15 focus:border-google-blue transition-all placeholder:text-slate-500 dark:placeholder:text-slate-400 placeholder:opacity-100"
              required
            />
          </div>
  ...
  return (
    <div className="space-y-4">
      <div className="text-left bg-slate-50 dark:bg-slate-950 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-0.5">Set new password</p>
        <p className="text-[11px] text-slate-700 dark:text-slate-350 leading-relaxed font-medium">
      ...
      <div className="text-center pt-1">
        <button
          ...
          className="inline-flex items-center gap-1.5 text-[11px] font-bold text-slate-450 hover:text-slate-650 dark:text-slate-400 dark:hover:text-slate-200 transition-colors"
        >
          <ArrowLeft className="w-3 h-3" /> Back to Email Entry
        </button>
      </div>
    </div>
  );
