      ...
      <div className="container mx-auto px-6 pt-36 pb-24 max-w-3xl">
        ...
        <div className="space-y-10 text-foreground/70 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <p>For any queries regarding these Terms, contact us at <a href="mailto:support@bharatgamingleague.in" className="text-neon-cyan hover:underline">support@bharatgamingleague.in</a> or reach us on Telegram at <a href="https://t.me/freefire_tounamentt" className="text-neon-cyan hover:underline">t.me/freefire_tounamentt</a>.</p>
          </section>
