...
export default function TournamentsPage() {
  ...
  return (
    <main className="min-h-screen pt-32 bg-white dark:bg-slate-950 bg-dot-grid relative">
      <Navbar />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-12">
          ...
          <div className="flex bg-slate-50 dark:bg-slate-900 p-1 rounded-xl border border-slate-100 dark:border-slate-800 self-start md:self-auto">
